    ...
    <div className="min-h-screen flex items-center justify-center bg-zinc-50 dark:bg-zinc-950 p-6">
      ...
      >
        <div className="w-20 h-20 rounded-3xl bg-zinc-900 dark:bg-zinc-50 flex items-center justify-center mx-auto mb-8 shadow-xl">
          <FileText className="w-10 h-10 text-white dark:text-zinc-900" />
        </div>
        <h1 className="text-4xl font-bold text-zinc-900 dark:text-white mb-4">Report Summarizer</h1>
        ...
        <p className="text-zinc-500 dark:text-zinc-400 text-lg leading-relaxed mb-8">
          This tool will allow you to generate concise AI-powered summaries of your trading activity and portfolio performance reports. Stay tuned!
        </p>
        <Link
          href="/"
